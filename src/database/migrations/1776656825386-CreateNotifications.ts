...
export class CreateNotifications1776656825386 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_c24be561656e7219e2566f6774" ON "notifications" ("user_id", "isRead", "createdAt") `,
    );
    await queryRunner.query(
      `DO $$
      BEGIN
        IF NOT EXISTS (
          ...
          WHERE conname = 'FK_9a8a82462cab47c73d25f49261f'
        ) THEN
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_c24be561656e7219e2566f6774"`,
    );
